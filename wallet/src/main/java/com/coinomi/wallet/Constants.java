...
import com.coinomi.core.coins.CryptoGauleMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/Cryptogaule/Crypto-Gaule-Android-Wallet";

    public static final String VERSION_URL = "https://cryptogaule.fr/wallet";
    public static final String SUPPORT_EMAIL = "support@cryptogaule.fr";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(BitcoinMain.get(),      new ServerAddress("btc-cce-1.coinomi.com", 5001),
                                                    new ServerAddress("btc-cce-2.coinomi.net", 5001)),
            new CoinAddress(DogecoinMain.get(),     new ServerAddress("doge-cce-1.coinomi.com", 5003),
                                                    new ServerAddress("doge-cce-2.coinomi.com", 5003)),
           new CoinAddress(LitecoinMain.get(),     new ServerAddress("ltc-cce-1.coinomi.com", 5002),
                                                    new ServerAddress("ltc-cce-2.coinomi.com", 5002)),
            new CoinAddress(PeercoinMain.get(),     new ServerAddress("ppc-cce-1.coinomi.com", 5004),
                                                    new ServerAddress("ppc-cce-2.coinomi.com", 5004)),
            new CoinAddress(DashMain.get(),         new ServerAddress("drk-cce-1.coinomi.com", 5013),
                                                    new ServerAddress("drk-cce-2.coinomi.com", 5013)),
            new CoinAddress(BlackcoinMain.get(),    new ServerAddress("blk-cce-1.coinomi.com", 5015),
                                                    new ServerAddress("blk-cce-2.coinomi.com", 5015)),
            new CoinAddress(NamecoinMain.get(),     new ServerAddress("nmc-cce-1.coinomi.com", 5016),
                                                    new ServerAddress("nmc-cce-2.coinomi.com", 5016)),
            new CoinAddress(FeathercoinMain.get(),  new ServerAddress("ftc-cce-1.coinomi.com", 5017),
                                                    new ServerAddress("ftc-cce-2.coinomi.com", 5017)),
            new CoinAddress(MonacoinMain.get(),     new ServerAddress("mona-cce-1.coinomi.com", 5022),
                                                    new ServerAddress("mona-cce-2.coinomi.com", 5022)),
            new CoinAddress(NeoscoinMain.get(),     new ServerAddress("neos-cce-1.coinomi.com", 5027),
                                                    new ServerAddress("neos-cce-2.coinomi.com", 5027)),
            new CoinAddress(ParkbyteMain.get(),     new ServerAddress("pkb-cce-1.coinomi.com", 5035),
                                                    new ServerAddress("pkb-cce-2.coinomi.com", 5035)),
            new CoinAddress(NxtMain.get(),          new ServerAddress("176.9.65.41", 7876),
													new ServerAddress("176.9.65.41", 7876)),
			new CoinAddress(CryptoGauleMain.get(),     new ServerAddress("192.162.68.93", 5050),
                                                    new ServerAddress("192.162.68.93", 5050))
    ...
    static {
		...
		COINS_ICONS.put(CoinID.MONACOIN_MAIN.getCoinType(), R.drawable.manaco);
		...
		COINS_ICONS.put(CoinID.CRYPTOGAULE_MAIN.getCoinType(), R.drawable.cryptogaule);
        ...
        COINS_BLOCK_EXPLORERS.put(CoinID.NEOSCOIN_MAIN.getCoinType(), "http://explorer.infernopool.com/tx/%s");
		 COINS_BLOCK_EXPLORERS.put(CoinID.CRYPTOGAULE_MAIN.getCoinType(), "https://explorer.cryptogaule.fr/tx/%s");
    }
